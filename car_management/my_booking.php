                                    ...
                                    <div class="container">
                                        ...
                                        <div class="card border-dark mb-3">
                                            <div class="card-header">
                                                <h5 class="uppercase underline">BOOKING STATE</h5>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                if($query->rowCount() > 0)
                                                {
                                                    ...
                                                    {  ?>
                                                        ...
                                                        <div> <p class="card-text"><?php echo htmlentities($result->BrandName);?> - <?php echo htmlentities($result->VehiclesTitle);?></p></div>
                                                        <div> <p class="card-text">From Date:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>To Date:</b> <?php echo htmlentities($result->ToDate);?></p></div>
                                                        <?php if($result->Status==1)
                                                    { ?>
                                                         <a class="btn btn-outline-success btn-xs active-btn" style="clear: both; float:right; margin-bottom: 10px; margin-top: 10px; position: relative;">Confirmed</a>
                                                        <div class="clearfix"></div>


                                                    <?php } else if($result->Status==2) { ?>
                                                        <a class="btn btn-outline-danger btn-xs" style="clear: both; float:right; margin-bottom: 10px; margin-top: 10px; position: relative;">Cancelled</a>
                                                        <div class="clearfix"></div>



                                                    <?php } else { ?>
                                                       <a class="btn btn-outline-warning btn-xs" style="clear: both; float:right; margin-bottom: 10px; margin-top: 10px; position: relative;">Not Confirm yet</a>
                                                        <div class="clearfix"></div>
                                                    <?php } ?>
