					...
					<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h4 class="m-0 font-weight-bold text-primary text-center">DASHBOARD</h4>
                            </div>
                        </div>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-success text-center"><marquee behavior="scroll">WELCOME IN CARENT ADMIN</marquee> </h5>
                            </div>
                        </div>
