	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
                ...
                <li class="ts-label align-bottom" >
                        <a class="align-center" href="dashboard.php" style="font-size: 12px; margin-right: 5px;"><i class="fa fa-car fa-2x" aria-hidden="true" ><strong>CARENT</strong></i></a></li>
